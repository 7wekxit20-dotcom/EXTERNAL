...
func log(_ msg: String) { AppLog.shared.append("[MOU7I EXTERNAL] \(msg)") }
...
enum AppUpdateChecker {
    ...
    static let apiURL = URL(string: "https://api.github.com/repos/YangJiiii/MOU7I EXTERNAL/releases/latest")!
    static let fallbackURL = URL(string: "https://github.com/YangJiiii/MOU7I EXTERNAL/releases/latest")!
    ...
    static func check() async -> Offer? {
        ...
        request.setValue("MOU7I EXTERNAL", forHTTPHeaderField: "User-Agent")
